...
export const zhCN = {
  ...
  'level.confirm.status.title': '确定要{action}吗？',
  'level.confirm.status.content': '{action}告警等级 "{name}"',

  'level.modal.create.title': '新建告警等级',
  'level.modal.edit.title': '编辑告警等级',
  'level.modal.detail.title': '告警等级详情',
  ...
  'level.detail.updatedAt': '更新时间',
  'level.detail.metadata': '元数据',

  'level.form.name.label': '名称',
...
export const enUS = {
  ...
  'level.confirm.status.title': 'Confirm to {action}?',
  'level.confirm.status.content': '{action} alert level "{name}"',

  'level.modal.create.title': 'Create Alert Level',
  'level.modal.edit.title': 'Edit Alert Level',
  'level.modal.detail.title': 'Alert Level Detail',
  ...
  'level.detail.updatedAt': 'Updated At',
  'level.detail.metadata': 'Metadata',

  'level.form.name.label': 'Name',
