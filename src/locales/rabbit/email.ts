...
export const zhCN = {
  ...
  'email.form.username.placeholder': '请输入SMTP用户名（邮箱）',
  'email.form.username.required': '请输入用户名',
  'email.form.username.emailFormat': '请输入有效的邮箱地址',
...
export const enUS = {
  ...
  'email.form.username.placeholder': 'Please enter SMTP username (email)',
  'email.form.username.required': 'Please enter username',
  'email.form.username.emailFormat': 'Please enter a valid email address',
