...
/** 告警状态枚举（与 proto rabbit/enum AlertStatus 一致） */
export enum AlertStatus {
  ALERT_STATUS_UNKNOWN = 'ALERT_STATUS_UNKNOWN',
  ALERT_EVENT_STATUS_FIRING = 'ALERT_EVENT_STATUS_FIRING',
  ALERT_EVENT_STATUS_RECOVERED = 'ALERT_EVENT_STATUS_RECOVERED',
  ALERT_EVENT_STATUS_RECOVERED_BY_MANUAL = 'ALERT_EVENT_STATUS_RECOVERED_BY_MANUAL',
}
