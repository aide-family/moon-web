...
export const getStrategyGroupList = (
  ...
  return http.get<StrategyGroupListResponse>('/strategy-groups', { ...params })
}

/** 获取策略组详情 GET /v1/strategy-group/{uid} */
export const getStrategyGroupDetail = (
  uid: string,
...
export const createStrategyGroup = (
  ...
  return http.post<CreateStrategyGroupReply>('/strategy-group', { ...params })
}
...
export const updateStrategyGroup = (
  ...
  return http.put<Record<string, never>>(`/strategy-group/${uid}`, {
    ...params,
  })
}
...
export const deleteStrategyGroup = (
  uid: string,
): Promise<Record<string, never>> => {
...
export const getStrategyGroupSelectList = (
  ...
  return http.get<StrategyGroupSelectResponse>('/strategy-groups/select', {
    ...params,
  })
}
