...
import { wechatJsonSchema } from './config/wechat'
...
export const WechatTemplateEditor: React.FC<WechatTemplateEditorProps> = ({
  ...
  const handleEditorDidMount = (editor: any, monaco: Monaco) => {
    ...
    // 自定义编辑器主题
    monaco.editor.defineTheme('wechatTheme', {
    ...
    // 设置主题
    monaco.editor.setTheme('wechatTheme')
    ...
    monaco.languages.json.jsonDefaults.setDiagnosticsOptions({
      ...
      schemas: [
        {
          uri: 'http://myserver/wechat-schema.json',
          fileMatch: ['*'],
          schema: wechatJsonSchema
        }
      ],
