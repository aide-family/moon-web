  ...
  return (
    ...
    >
      {loading ? (
        ...
        >
          <Descriptions.Item label={t('jadeTree.command.uid')}>
            {data.uid || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('jadeTree.command.name')}>
            {data.name || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('common.status')}>
            <Tag color={statusColor}>{t(statusLabel)}</Tag>
          </Descriptions.Item>
          <Descriptions.Item label={t('jadeTree.command.description')}>
            {data.description || '-'}
          </Descriptions.Item>
