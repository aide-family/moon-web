  ...
  return (
    ...
    >
      {loading ? (
        ...
        >
          <Descriptions.Item label={t('email.detail.uid')}>
            {data.uid || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('email.detail.name')}>
            {data.name || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('email.detail.host')}>
            {data.host || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('email.detail.port')}>
            {data.port != null ? data.port : '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('email.detail.username')}>
            {data.username || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('email.detail.password')}>
            ******
          </Descriptions.Item>
          <Descriptions.Item label={t('email.table.status')}>
