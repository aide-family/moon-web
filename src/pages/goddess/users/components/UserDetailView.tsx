  ...
  return (
    ...
    >
      {data ? (
        ...
        >
          <Descriptions.Item label={t('user.detail.uid')}>
            {data.uid || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('user.detail.email')}>
            {data.email || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('user.detail.name')}>
            {data.name || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('user.detail.nickname')}>
            {data.nickname || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('user.detail.phone')}>
            {data.phone || '-'}
          </Descriptions.Item>
          <Descriptions.Item label={t('user.table.status')}>
          ...
          <Descriptions.Item label={t('user.detail.remark')}>
            {data.remark || '-'}
          </Descriptions.Item>
