    ...
    >
      <Form form={form} layout='vertical' autoComplete='off'>
        ...
        <Form.Item label={t('namespace.form.remark.label')} name='remark'>
          <Input.TextArea
            placeholder={t('namespace.form.remark.placeholder')}
            rows={2}
          />
        </Form.Item>
        ...
        <Form.Item
          label={t('namespace.form.banners.label')}
          help={t('namespace.form.banners.help')}
        >
              ...
              <>
                {fields.map(({ key, name, ...restField }) => (
                  <div key={key} style={{ display: 'flex', marginBottom: 12 }}>
                    ...
                    >
                      <Input
                        placeholder={t('namespace.form.banners.placeholder')}
                      />
                    </Form.Item>
