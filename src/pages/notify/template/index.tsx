...
import { SendTemplateItem } from '@/api/model-types'
import { deleteTemplate, getTemplateList, GetTemplateListRequest, updateTemplateStatus } from '@/api/notify/template'
...
const Template: React.FC = () => {
  ...
  }, [searchParams, refresh, runGetTemplateList])
