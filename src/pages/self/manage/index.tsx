	...
	const showUpdateModal = (type: 'phone' | 'email' | 'avatar') => {
		...
		confirm({
			...
			content: (
				<DataFrom
					items={options}
					props={{ layout: 'vertical', form, initialValues: userDetail }}
				/>
			),
			okText: '保存',
			onOk() {
			...
			case 'password':
				return (
					<DataFrom
						...
						props={{ layout: 'vertical', form, onFinish: updatePassword }}
					>
						<Form.Item>
			...
			>
				<div className='manage-user'>
					<div className='manage-user-avatar ant-image-mask'>
						<Avatar
							className='manage-user-avatar-box'
