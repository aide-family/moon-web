...
import { GlobalStatus, LevelType, type LevelItem } from '@/api/marksman/level'
  ...
  return (
    ...
    >
      {loading ? (
        ...
        >
          <Descriptions.Item label={t('level.detail.uid')}>
            {emptyPlaceholder(data.uid)}
          </Descriptions.Item>
          <Descriptions.Item label={t('level.detail.name')}>
            {emptyPlaceholder(data.name)}
          </Descriptions.Item>
          <Descriptions.Item label={t('level.detail.type')}>
            {getLevelTypeLabel(data.type ?? LevelType.LEVEL_TYPE_UNKNOWN, t)}
          </Descriptions.Item>
          ...
          <Descriptions.Item label={t('level.detail.status')}>
            {renderStatusTag(data.status ?? GlobalStatus.UNKNOWN, t)}
          </Descriptions.Item>
          <Descriptions.Item label={t('level.detail.remark')}>
