...
const TYPE_DRIVER_MAP: Record<string, string[]> = {
  [DatasourceType.METRICS]: [
    DatasourceDriver.METRICS_PROMETHEUS,
    DatasourceDriver.METRICS_VICTORIA_METRICS,
  ],
...
const DetailForm: React.FC<DetailFormProps> = ({
  ...
  return (
    <Modal
      title={
        mode === 'create'
          ? t('strategy.modal.create.title')
          : t('strategy.modal.edit.title')
      }
      open={open}
      onOk={handleSubmit}
    ...
    >
      <Form form={form} layout='vertical' preserve={false}>
        <Form.Item
          ...
          rules={[
            { required: true, message: t('strategy.form.name.placeholder') },
          ]}
        >
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: t('strategy.form.type.placeholder') },
          ]}
        >
          <Select
            allowClear
            ...
            onChange={(newType) => {
              ...
              if (
                currentDriver &&
                allowed.length > 0 &&
                !allowed.includes(currentDriver)
              ) {
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: t('strategy.form.driver.placeholder') },
          ]}
        >
          <Select
            allowClear
        ...
        {hideStrategyGroupSelect ? (
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: t('strategy.form.strategyGroup.placeholder'),
              },
            ]}
          >
            <Select
        ...
        <Form.Item name='remark' label={t('strategy.form.remark.label')}>
          <Input.TextArea
            rows={2}
            placeholder={t('strategy.form.remark.placeholder')}
            allowClear
          />
        </Form.Item>
      </Form>
